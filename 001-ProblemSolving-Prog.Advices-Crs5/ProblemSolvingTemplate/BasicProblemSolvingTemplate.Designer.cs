...
{
	partial class BasicProblemSolvingTemplate
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			btnCheck.Location = new Point( 90, 430 );
			btnCheck.Name = "btnCheck";
			btnCheck.Size = new Size( 542, 158 );
			btnCheck.TabIndex = 3;
			btnCheck.Text = "Check if";
			...
			label1.Text = "Title";
			// 
			// BasicProblemSolvingTemplate
			// 
			AutoScaleDimensions = new SizeF( 10F, 25F );
			AutoScaleMode = AutoScaleMode.Font;
			Controls.Add( panel2 );
			Controls.Add( panel1 );
			Name = "BasicProblemSolvingTemplate";
			Size = new Size( 1659, 895 );
